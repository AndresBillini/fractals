function submit(x){
    ...
    if(x==1){
          ...
          xmlhttp.onreadystatechange = function(){
            ...
            xmlhttp.open('GET','form/contactus.php?name='+document.contactForm.name.value+'&mail='+document.contactForm.mail.value+'&message='+document.contactForm.message.value,true);
            xmlhttp.send();  
    }
    ...
    if(x==2){
          ...
          xmlhttp.onreadystatechange = function(){
            ...
            xmlhttp.open('GET','form/contactm.php?name='+document.contactForm.name.value+'&mail='+document.contactForm.mail.value+'&message='+document.contactForm.message.value,true);
            xmlhttp.send();  
    }
