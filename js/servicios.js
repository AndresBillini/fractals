...
function hexRotate() {
    ...
    if (navigator.userAgent.indexOf("Firefox") > 0) {//FIREFOX
        ...
        switch (g){
            case 0:
                hTt.innerHTML="INVESTIGACIÓN";
                hTx.innerHTML="Investigación mercado<br>Investigación de palabras clave<br>Investigación artística";
            ...
            case 1:
                hTt.innerHTML="DISEÑO";
                hTx.innerHTML="Identidad corporativa<br>Diseño de interfaz<br>Experiencia de usuario<br>Adaptación de contenido";
            ...
            case 2:
                hTt.innerHTML="Desarrollo";
                hTx.innerHTML="Búsqueda de dominio<br>Servicios de alojamiento<br>Sitio web<br>Versión movil<br>Responsividad<br>Bases de datos<br>Correo corporativo";
            ...
            case 3:
                hTt.innerHTML="Optimización de motores de busqueda";
                hTx.innerHTML="Terminal de búsquedas<br>Selección de palabras clave<br>Formulación de descripción<br>Snippets y Google bots";
            ...
            case 4:
                hTt.innerHTML="ANALÍTICA";
                hTx.innerHTML="Seguimiento de métrica<br>Reporte de comportamiento de audiencia<br>Reporte de desempeño de palabras clave<br>Reporte de desempeño de terminal de búsquedas";
            ...
            case 5:
                hTt.innerHTML="COMUNIDAD";
                hTx.innerHTML="Integración de redes sociales<br>Gestión de contenido y manejo de comunidades<br>Reporte de métrica de redes sociales<br>Configuración de correo";
