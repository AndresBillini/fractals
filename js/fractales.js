  ...
  for (i=0;i<350;i++){
    if (i==13 || i==39 || i==65 || i==91 || i==117 || i==143 || i==169 || i==195 || i==221 || i==247 || i==273 || i==299 || i==325){
      ...
      if (i==28){
        ...
        if(i==rCh1 || i==rCh2 || i==rCh3 || i==rCh4 || i==rCh5 || i==rCh6){
          var services = '"servicios.html"';
          var portfolio = '"portafolio.html"';
          var about='"nosotros.html"';
          if(i==rCh1){
              hexH.innerHTML+="<a href="+services+"><div class='hex opt' onmouseover='optColor(this)' onmouseout='optColor2(this)'><p class='optTitle'>SERVICIOS</p></div></a>";
          }
          if(i==rCh2){
              hexH.innerHTML+="<a href="+portfolio+"><div class='hex opt' onmouseover='optColor(this)' onmouseout='optColor2(this)'><p class='optTitle'>PORTAFOLIO</p></div></a>";
          }
          if(i==rCh3){
              hexH.innerHTML+="<a href="+about+"><div class='hex opt' onmouseover='optColor(this)' onmouseout='optColor2(this)'><p class='optTitle'>NOSOTROS</p></div></a>";
          }
          if(i==rCh4){
              hexH.innerHTML+="<a href='experimentos.html'><div class='hex opt' onmouseover='optColor(this)' onmouseout='optColor2(this)'><p class='optTitle'>EXPERIMENTOS</p></div></a>";
          }
          if(i==rCh5){
              hexH.innerHTML+="<div class='hex opt' onmouseover='optColor(this)' onmouseout='optColor2(this)'  onclick='deployContact(0)'><p class='optTitle'>CONTÁCTANOS</p></div>";
          }
          if(i==rCh6){
              hexH.innerHTML+="<a href='http://en.fractals.studio/'><div class='hex sixtySix' onmouseover='optColor(this)' onmouseout='optColor3(this)' ><p class='optTitle'>IN ENGLISH</p></div></a>";
          }
        }else{
          if(i==29 || i==30 || i==31){
